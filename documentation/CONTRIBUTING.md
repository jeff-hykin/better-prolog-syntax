...
- Create a `your_feature.prolog` file in the `language_examples/` folder. Once it is created, add code to it that demonstrates your feature (more demonstration the better).
...
```json
{
    ...
    "name": "punctuation.separator.attribute.prolog",
    "patterns": [
        {
...
```json
{
    ...
    "beginCaptures": {
        "0": {
            "name": "punctuation.section.attribute.begin.prolog"
        }
    },
    "endCaptures": {
        "0": {
            "name": "punctuation.section.attribute.end.prolog"
        }
    },
    "name": "support.other.attribute.prolog",
    "patterns": [
        {
